...
const data = [
  ...
  },
  {
    ...
    description: 'Choosing Stagic was one of the best decisions for our small business. Their dedication to data security has given us the confidence to focus on growth. Highly recommended!',
    avatar: Avatar2,
...
export default function TestimonialCard() {
  return (
    <section id="testimonial" sx={{ variant: 'section.testimonial' }}>
      <Container>
        <SectionHeader slogan="Testimonials" title="Hear from satisfied clients" />
      </Container>
